<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnvioSunat.aspx.cs" Inherits="APU.Presentacion.Operaciones.EnvioSunat" EnableEventValidation="false" %>
...
<script type="text/javascript">
    ...
    function ObtenerVentaOk(v) {
        ...
        if (v != null) {
            ...
            lblNumeroDocumento.innerText = v.NumeroDocumento;
            ddlTipoComprobante.value = v.TipoComprobanteId;
            document.getElementById('lblTituloVenta').innerText = v.NumeroSerie + '-' + v.NumeroComprobante;

            lblNumeroComprobante.innerText = v.NumeroSerie + '-' + v.NumeroComprobante;
            lnkNumeroComprobante.onclick = function () { return ImprimirComprobante(v.NumeroDocumento, v.ComprobanteImpreso); };

            txtNumeroComprobante.value = v.NumeroComprobante;
            txtNumeroSerie.value = v.NumeroSerie;
            ...
            <tr>
                <td style="width: 100%;">
                    <table style="width: 100%; margin: 0;">
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="width: 30%;" colspan="2">
                                            <span class="lblStandar">De:</span>&nbsp;<asp:TextBox id="txtFechaEmisionInicioBuscar" CssClass="txtStandarFecha" Width="25%" runat="server"></asp:TextBox>&nbsp;
                                            <asp:ImageButton ID="imgFechaEmisionInicioBuscar" CssClass="imgCalendario" ImageUrl="~/Scripts/dhtmlxCalendar/calendar.gif" runat="server"/>
                                            <ajaxToolkit:CalendarExtender runat="server" ID="ceFechaEmisionInicioBuscar" BehaviorID="bceFechaEmisionInicioBuscar" CssClass="custom-calendar" TargetControlID="txtFechaEmisionInicioBuscar" Format="dd/MM/yyyy" PopupButtonID="imgFechaEmisionInicioBuscar" />&nbsp;&nbsp;&nbsp;&nbsp;

                                            <span class="lblStandar">Hasta:</span>&nbsp;<asp:TextBox id="txtFechaEmisionFinBuscar" CssClass="txtStandarFecha" Width="25%" runat="server"></asp:TextBox>&nbsp;
                                            <asp:ImageButton ID="imgFechaEmisionFinBuscar" CssClass="imgCalendario" ImageUrl="~/Scripts/dhtmlxCalendar/calendar.gif" runat="server"/>
                                            <ajaxToolkit:CalendarExtender runat="server" ID="ceFechaEmisionFinBuscar" BehaviorID="bceFechaEmisionFinBuscar" CssClass="custom-calendar" TargetControlID="txtFechaEmisionFinBuscar" Format="dd/MM/yyyy" PopupButtonID="imgFechaEmisionFinBuscar" />
                                        </td>
                        ...
                        <tr>
                            <td colspan="3">
                                <input type="button" id="btnAnular" value="Anular CPE" class="btnStandar" runat="server" style="width: 20%;" onclick="return AnularSunat();" />&nbsp;
                                <input type="button" id="btnNotaCredito" value="Nota Cr&eacute;dito" class="btnStandar" runat="server" style="width: 20%;" onclick="return GenerarNotaCredito();" />&nbsp;
                                <input type="button" id="btnNotaDebito" value="Nota D&eacute;bito" class="btnStandar" runat="server" style="width: 20%;" />
                                <%--<input type="button" id="btnExportar" value="Exportar" class="btnStandarExportar" runat="server" style="width: 20%;" />--%>
                                <asp:Button ID="btnExportar" Text="Exportar" CssClass="btnStandarExportar" runat="server" width="20%" OnClick="btnExportar_Click" />
                            </td>
                            <td colspan="2">
                                <input type="button" id="btnEnviarLote" value="Enviar Lote" class="btnStandarEnviarLote" style="width: 20%;" onclick="return EnviarLote();" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td style="width: 20%;">
                                Buscar:
                                <asp:TextBox id="txtBuscar" CssClass="txtStandar" Width="60%" runat="server"></asp:TextBox>
                            </td>
                    ...
                    <div id="divHeader" style="width: 1182px; overflow-x: hidden; overflow-y: hidden; margin: 0 0px 0 0px;" >
                        <table id="dummyHeader" style="width: 2000px;" class="tblSinBordes">
                            ...
                            <tr class="filaCabeceraGrid">
                                <th style="width: 5%; cursor: default; text-decoration: none;">Acciones&nbsp;<asp:CheckBox id="chkTodas" runat="server" onclick="return SeleccionaTodas();" /></th>
                            ...
                            <asp:GridView id="grvVenta" AutoGenerateColumns="False" Width="2000px" RowStyle-Wrap="True" runat="server" OnRowDataBound="grvVenta_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Acciones">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ImageUrl="~/Imagenes/Iconos/editar.png" CssClass="imgButton" OnClientClick='<%# "return VerVenta(" + Eval("VentaId") + ");" %>' ToolTip="Editar" />&nbsp;
                                            <asp:CheckBox id="chkUna" runat="server" onclick="return SeleccionaUna(this);" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- 10: Estado --%>
                                    ...
                                    <asp:TemplateField HeaderText="# Comprobante">
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink Target="_blank" Text='<%# Eval("NumeroSerie").ToString().Trim() + "-" + Eval("NumeroComprobante").ToString().Trim() %>' NavigateUrl='<%# Page.ResolveClientUrl("~/Archivos/Documentos/Cliente") + "/" + Eval("NumeroDocumento") + "/" + Eval("ComprobanteImpreso") + "?v=" + Guid.NewGuid().ToString() %>' runat="server" data-toogle="tooltip" ToolTip="Descargar PDF" title="Descargar PDF"></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- 3: Cliente --%>
        ...
        <table style="width: 100%;">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <%--&nbsp;&nbsp;
                                            <a onclick="return ImprimirComprobanteNuevo();" style="cursor: pointer;">Nuevo</a>--%>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <tr>
                <td colspan="3" style="text-align: center;">
                    ...
                    <input type="button" id="btnEnviarSunat" value="Enviar SUNAT" class="btnStandar" style="width: 30%;" onclick="return EnviarSunat();"/>
    ...
    <ajaxToolkit:RoundedCornersExtender ID="rceVenta" runat="server" BehaviorID="rcbVenta" TargetControlID="pnlVenta" Radius="6" Corners="All" />
        <%--<asp:Panel ID="pnlNotaCredito" runat="server" CssClass="pnlModal" style="display: none;">
            <table style="width: 100%;">
                <tr id="lblTituloPopupNotaCredito" class="lblTituloPopup">
                    <td style="width: 20%;" class="lblTituloPopup">&nbsp;</td>
                    <td id="lblTituloNotaCredito" class="lblTituloPopup" style="width: 60%">Venta</td>
                    <td class="lblTituloPopup" style="width: 20%; text-align: right;">
                        <a onclick="return Cerrar();" style="color: #FFFFFF; text-decoration: none; cursor: pointer;">Cerrar X</a>&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
                ...
                <tr>
                    <td class="lblStandar">Comprobante Afecta</td>
                    <td>
                        <asp:
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    function EnviarSunat() {
        ...
        if (tipoComprobanteId == TipoComprobanteFactura || tipoComprobanteId == TipoComprobanteBoletaVenta) {
            Bloquear(100002);
            PageMethods.EnviarSunat(ventaId, EnviarSunatOk, fnLlamadaError);
        }
        if (tipoComprobanteId == TipoComprobanteNotaCredito) {
            Bloquear(100002);
            PageMethods.EnviarSunatNotaCredito(ventaId, GenerarNotaCreditoOk, fnLlamadaError);
        }
    ...
    function SeleccionaUna(obj) {
        var chkUnaSeleccionada = obj;
        var totalFilas = 0;
        var totalSeleccionadas = 0;
        var grid = document.getElementById('grvVenta');
        var chkTodas = document.getElementById('<%=chkTodas.ClientID%>');
        if (grid != null) {
            if (grid.rows.length > 0) {
                totalFilas = grid.rows.length - 1;
                for (var r = 1; r < grid.rows.length; r++) {
                    var chkUna = grid.rows[r].cells[0].children[1];
                    if (chkUna.checked) {
                        totalSeleccionadas++;
                    }
                }
                if (totalSeleccionadas == totalFilas) {
    ...
    function SeleccionaTodas() {
        ...
        if (grid != null) {
            if (grid.rows.length > 0) {
                for (var r = 1; r < grid.rows.length; r++) {
                    var chkUna = grid.rows[r].cells[0].children[1];
                    chkUna.checked = chkTodas.checked;
                }
            }
        }
    }
    function EnviarLote() {
        ...
        if (grid != null) {
            ...
            if (grid.rows.length > 0) {
                for (var r = 1; r < grid.rows.length; r++) {
                    var chkUna = grid.rows[r].cells[0].children[1];
                    if (chkUna.checked) {
                        var idArray = chkUna.id.split('_');
                        var ventaId = idArray[2];
                        ventas = ventas + ventaId + ',';
                    }
                }
            }
        }
        ...
        if (ventas.length > 0) {
            Bloquear(100002);
            PageMethods.EnviarLote(ventas, EnviarLoteOk, fnLlamadaError);
        } else {
            MostrarMensaje('Debe seleccionar uno o más Comprobantes. Se sugiere elegir todas las boletas del día.');
        }
    }
    function EnviarLoteOk(r) {
        if (r != null) {
            var lblMensajeSunat = document.getElementById('<%=lblMensajeSunat.ClientID%>');
            var mensaje = '';

            lblMensajeSunat.innerText = r;
            MostrarMensaje(r);
        }
        Desbloquear();
        return false;
    ...
    function AnularSunat() {
        ...
        var arrayVenta = ventas.split(',');

        if (arrayVenta.length != 1) {
            MostrarMensaje('Debe seleccionar un comprobante.');
            return false;
        } else {
            var ventaId = arrayVenta[0];

            if (ventaId != '') {
                var motivoAnulacion = 'Anulación de comprobante.';
                Bloquear(100002);
                PageMethods.AnularSunat(ventaId, motivoAnulacion, AnularSunatOk, fnLlamadaError);
            } else {
                MostrarMensaje('Debe seleccionar un comprobante.');
                return false;    
            }
    ...
    function AnularSunatOk(r) {
        if (r != null) {
            var lblMensajeSunat = document.getElementById('<%=lblMensajeSunat.ClientID%>');
            <%--var txtNroTicket = document.getElementById('<%=txtNroTicket.ClientID%>');--%>
            var mensaje = '';
            if (r.Exito) {
                mensaje = 'La anulación fue informada correctamente con Nro de Ticket: ' + r.NroTicket;
            } else {
                mensaje = 'No se pudo realizar la anulación, consulte por el Nro de Ticket: ' + r.NroTicket;
            }
            //lblMensajeSunat.innerText = mensaje;
            //txtNroTicket.value = r.NroTicket;
            MostrarMensaje(mensaje);
            document.getElementById('btnCargarVentas').click();
        }
        Desbloquear();
    ...
    function GenerarNotaCredito() {
        ...
        if (arrayVenta.length != 1) {
            ...
            if (ventaId != '') {
                // var motivoAnulacion = 'Anulación de comprobante.';
                Bloquear(100002);
                PageMethods.GenerarNotaCredito(ventaId, GenerarNotaCreditoOk, fnLlamadaError);
            } else {
                MostrarMensaje('Debe seleccionar un comprobante.');
                return false;
            }
    ...
    function GenerarNotaCreditoOk(r) {
        if (r != null) {
            var lblMensajeSunat = document.getElementById('<%=lblMensajeSunat.ClientID%>');
            var mensaje = '';
            if (r.Exito) {
                mensaje = 'La anulación fue informada correctamente';
            } else {
                mensaje = 'No se pudo realizar la anulación, consulte por el Nro de Ticket: ' + r.NroTicket;
            }
            MostrarMensaje(mensaje);
