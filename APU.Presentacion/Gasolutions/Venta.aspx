<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Venta.aspx.cs" Inherits="APU.Presentacion.Gasolutions.VentaGasolutions" EnableEventValidation="false" %>
...
<script type="text/javascript">
    ...
    function ObtenerVentaOk(v) {
        ...
        if (v != null) {
            ...
            hdnVentaId.value = v.VentaGasolutionsId;
            hdnVentaPetroamericaId.value = v.VentaGasolutionsId;
            //hdnVentaId.value = v.VentaId;
            txtCliente.value = v.NombreComercialReceptor;
            lblNumeroDocumento.innerText = v.NroDocumentoReceptor;
            ddlTipoComprobante.value = v.TipoDocumento;
            document.getElementById('lblTituloVenta').innerText = v.IdDocumento;

            lblNumeroComprobante.innerText = v.IdDocumento;
            lnkNumeroComprobante.onclick = function () { return ImprimirComprobante(v.NroDocumentoReceptor, v.ComprobanteImpreso); };

            txtNumeroComprobante.value = v.IdDocumento;
            txtNumeroSerie.value = v.IdDocumento;
                    ...
                    <div id="divHeader" style="width: 1182px; overflow-x: hidden; overflow-y: hidden; margin: 0 0px 0 0px;" >
                        <table id="dummyHeader" style="width: 2000px;" class="tblSinBordes">
                            ...
                            <tr class="filaCabeceraGrid">
                                ...
                                <th style="width: 5%; cursor: pointer; text-decoration: underline;">Descuento</th>
                            ...
                            <asp:GridView id="grvVenta" AutoGenerateColumns="False" Width="2000px" RowStyle-Wrap="True" runat="server" OnRowDataBound="grvVenta_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Acciones">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ImageUrl="~/Imagenes/Iconos/editar.png" CssClass="imgButton" OnClientClick='<%# "return VerVenta(" + Eval("VentaGasolutionsId") + ");" %>' ToolTip="Editar" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- 10: Estado --%>
                                    ...
                                    <asp:TemplateField HeaderText="Nombre">
                                        <ItemStyle Width="5%" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <%# Eval("TipoDocumento").ToString().Trim() %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- 2: # Comprobante --%>
                                    <asp:TemplateField HeaderText="# Comprobante">
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink Target="_blank" Text='<%# Eval("IdDocumento").ToString().Trim() %>' onclick=<%# "ImprimirComprobante('" + Eval("IdDocumento") + "', '" + Eval("ComprobanteImpreso") + "');" %> runat="server" data-toogle="tooltip" ToolTip="Descargar PDF" title="Descargar PDF" style="cursor: pointer;"></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- 3: Cliente --%>
                                    ...
                                    <asp:TemplateField HeaderText="Monto">
                                        ...
                                        <ItemTemplate>
                                            <%--<%# Convert.ToDecimal(Eval("TotalVenta")).ToString("N2") %>--%>
                                            <%# (Convert.ToDecimal(Eval("TotalVenta")) - Convert.ToDecimal(Eval("TotalIgv"))).ToString("N2") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- 8: MontoImpuesto --%>
                                    <asp:TemplateField HeaderText="MontoImpuesto">
                                        <ItemStyle Width="6%" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <%# Convert.ToDecimal(Eval("TotalIgv")).ToString("N2") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- 9: Monto Total --%>
                                    ...
                                    <asp:TemplateField HeaderText="Fecha Vencimiento">
                                        <ItemStyle Width="5%" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <%# Convert.ToDecimal(Eval("Descuento")).ToString("N2") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%-- 11: Forma Pago --%>
