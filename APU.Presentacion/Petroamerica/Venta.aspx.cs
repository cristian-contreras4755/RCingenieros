...
{
    public partial class VentaPetroamerica : PaginaBase
    {
        ...
        private void CargarInicial()
        {
            ...
            var agenciaInfo = new Negocio.VentaPetroamerica().ListarAgencia(String.Empty);
            LlenarCombo(ddlAgencia, agenciaInfo, "Agencia", "Agencia");
            ddlAgencia.Items.Insert(0, new ListItem("Todos", ""));
        ...
        private void CargarDatos()
        {
            ...
            var agenciaBuscar = ddlAgencia.SelectedValue;
            ...
            //var ventaInfoLista = new Negocio.Venta().ListarPaginado(0, rucBuscar, tipoComprobanteBuscar, fechaInicioBuscar, fechaFinBuscar, estadoBuscar, monedaBuscar, numeroRegistros, indicePagina);
            var ventaInfoLista = new Negocio.VentaPetroamerica().ListarPaginado(0, rucBuscar, tipoComprobanteBuscar, "", "", fechaInicioBuscar, fechaFinBuscar, estadoBuscar, monedaBuscar, agenciaBuscar, numeroRegistros, indicePagina);
        ...
        #region WebMethod
        [WebMethod]
        public static VentaPetroamericaInfo ObtenerVenta(int ventaPetroamericaId, int ventaId)
        {
            //return new Negocio.Venta().Listar(ventaId).FirstOrDefault();
            return new Negocio.VentaPetroamerica().Listar(ventaPetroamericaId, ventaId).FirstOrDefault();
        }
        #endregion
