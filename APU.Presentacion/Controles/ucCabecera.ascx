<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCabecera.ascx.cs" Inherits="APU.Presentacion.Controles.ucCabecera" %>
<table style="width: 100%; height: 10%">
    <tr>
        <td style="width: 20%; text-align:center">
            <asp:Image id="imgLogoEmpresa" runat="server" CssClass="imgLogoEmpresa" ImageUrl="~/Imagenes/logo-primax-sm.png" Width="257" Height="79" />
        </td>
