<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Almacen.aspx.cs" Inherits="APU.Presentacion.Configuracion.Almacen" EnableEventValidation="false" %>
...
<script type="text/javascript">
    function Buscar() {
        var grid = document.getElementById('grvAlmacen');
    ...
    function VerAlmacen(almacenId) {
        PageMethods.ObtenerAlmacen(almacenId, ObtenerAlmacenOk, fnLlamadaError);
        return false;
    }
    function LimpiarAlmacen() {
        var hdnAlmacenId = document.getElementById('<%=hdnAlmacenId.ClientID%>');
        ...
        hdnAlmacenId.value = 0;
        ddlEmpresa.value = 0;
        document.getElementById('lblTituloAlmacen').innerText = 'Almacen';
        txtNombre.value = '';
        txtCodigo.value = '';
        ...
        var tabAlmacen = $get('<%=tabAlmacen.ClientID%>');
        tabAlmacen.control.set_activeTabIndex(0);
    }
    function ObtenerAlmacenOk(a) {
        var modalDialog = $find('mpeAlmacen');
        if (a != null) {
            modalDialog.show();
            ...
            hdnAlmacenId.value = a.AlmacenId;
            ddlEmpresa.value = a.EmpresaId;
            txtCodigo.value = a.Codigo;
            document.getElementById('lblTituloAlmacen').innerText = a.Nombre;
    ...
    function ValidarAlmacen() {
        ...
        if (txtNombre.value.trim() == '') {
            return MostrarValidacion(txtNombre, 'Ingrese el Nombre de la Almacen.');
        }
    }
    function GuardarAlmacenOk(res) {
        var modalDialog = $find('mpeAlmacen');
        var arr = res.split('@');
        var almacenId = arr[0];
        var mensaje = arr[1];
        ...
        if (almacenId > 0) {
            alert('Se registró la información de la Almacen correctamente.');
            modalDialog.hide();
            LimpiarAlmacen();
        } else {
            alert(mensaje);
    ...
    <form id="frmAlmacen" runat="server" DefaultButton="btnDefault">
                    ...
                    <table style="width: 100%; margin: 0;">
                        <tr>
                            <td style="text-align: center;" colspan="5">
                                <asp:Label CssClass="lblTitulo" Width="100%" runat="server">ALMAC&Eacute;N</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 10%;">
                            ...
                            <td style="width: 20%;">
                                <asp:LinkButton ID="imgAnadir" ForeColor="#404040" runat="server" ToolTip="" OnClientClick="return InsertarAlmacen();">
            ...
            <tr>
                <td style="width: 100%;">
                    ...
                    <asp:UpdatePanel ID="divData" runat="server" UpdateMode="Conditional" style="overflow: scroll; width: 1200px; height: 420px; margin: 0 0 0px 0px;" onscroll="Onscrollfnction();">
                        <ContentTemplate>
                            <asp:GridView id="grvAlmacen" AutoGenerateColumns="False" Width="1500px" RowStyle-Wrap="True" runat="server" OnRowDataBound="grvAlmacen_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Acciones">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ImageUrl="~/Imagenes/Iconos/editar.png" CssClass="imgButton" OnClientClick='<%# "return VerAlmacen(" + Eval("AlmacenId") + ");" %>' ToolTip="Editar" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <%--  1: Nombre --%>
                        ...
                        <Triggers>
                            ...
                            <asp:AsyncPostBackTrigger ControlID="btnGuardarAlmacen" EventName="Click" />
                        </Triggers>
                    </asp:UpdatePanel>
    ...
    <div id="derecha"></div>
    <asp:Panel ID="pnlAlmacen" runat="server" CssClass="pnlModal" style="display: none;">
        <table style="width: 100%;">
            <tr id="lblTituloPopupAlmacen" class="lblTituloPopup">
                <td style="width: 20%;" class="lblTituloPopup">&nbsp;</td>
                <td id="lblTituloAlmacen" class="lblTituloPopup" style="width: 60%">Almac&eacute;n</td>
            ...
            <tr>
                <td colspan="3">
                    <input type="hidden" id="hdnAlmacenId" value="0" runat="server" />
                </td>
            </tr>
            <tr>
                <td colspan="3" style="width: 100%;">
                    <ajaxToolkit:TabContainer id="tabAlmacen" runat="server" OnClientActiveTabChanged="" Height="350px" Width="600px" ActiveTabIndex="0" OnDemand="False" AutoPostBack="false"
                                              TabStripPlacement="Top" CssClass="ajax__tab_xp" ScrollBars="None" UseVerticalStripPlacement="False" VerticalStripWidth="120px">
                        <ajaxToolkit:TabPanel id="tabAlmacenInformacion" runat="server" HeaderText="Informaci&oacute;n de la Almacen" Enabled="true" ScrollBars="Auto" OnDemandMode="Always">
                            <ContentTemplate>
                                <table style="width: 100%;">
                                    <tr>
                                        <td class="lblStandar" style="width: 30%;">Empresa</td>
                                        <td>
                                            <asp:DropDownList id="ddlEmpresa" CssClass="ddlStandar" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox id="txtDescripcion" CssClass="txtStandar" TextMode="MultiLine" Rows="3" Width="80%" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <tr>
                <td colspan="3" style="text-align: center;">
                    <asp:Button ID="btnGuardarAlmacen" runat="server" CssClass="btnStandar" Text="Guardar" Width="30%" OnClientClick="return ValidarAlmacen();" OnClick="btnGuardarAlmacen_OnClick" />
                    <asp:Button ID="btnCancelarAlmacen" runat="server" CssClass="btnStandar" Text="Cancelar" Width="30%" />
                    <asp:button id="hButton" runat="server" style="display:none;" />
                </td>
            </tr>
        </table>
    </asp:Panel>
    <ajaxToolkit:ModalPopupExtender ID="mpeAlmacen" PopupControlID="pnlAlmacen" TargetControlID="hButton" CancelControlID="btnCancelarAlmacen" Drag="True" DropShadow="True" BackgroundCssClass="FondoAplicacion" ClientIDMode="Static" runat="server" PopupDragHandleControlID="lblTituloAlmacen"></ajaxToolkit:ModalPopupExtender>
        <ajaxToolkit:RoundedCornersExtender ID="rceAlmacen" runat="server" BehaviorID="rcbAlmacen" TargetControlID="pnlAlmacen" Radius="6" Corners="All" />
    </div>
    </form>
...
<script type="text/javascript">
    function pageLoad(sender, args) {
        $(document).ready(function () {
            $("#grvAlmacen").tablesorter({ dateFormat: 'uk' });
            SetDefaultSortOrder();
        });
    }
    function Sort(cell, sortOrder) {
        var sorting = [[cell.cellIndex, sortOrder]];
        $("#grvAlmacen").trigger("sorton", [sorting]);
        if (sortOrder == 0) {
            sortOrder = 1;
    ...
    function RedimensionarGrid() {
        ...
        var grvAlmacen = document.getElementById('grvAlmacen').clientWidth;
        ...
        if (dummyHeader < divHeader) {
            ...
            document.getElementById('grvAlmacen').style.width = divData + 'px';
        }
    ...
    function InitializeRequest(sender, args) {
        ...
        if (postBackElement.id == 'btnGuardarAlmacen') {
            // Bloqueo Pantalla
            Bloquear();
        }
    }
    ...
    function grvAlmacen_OnDnlClick(row) {
        debugger;
        var indiceAlmacenId = 5;
        var almacenIdRow = RetornarCeldaValor(row, indiceAlmacenId);

        VerAlmacen(almacenIdRow);
    }
</script>
</body>
</html>