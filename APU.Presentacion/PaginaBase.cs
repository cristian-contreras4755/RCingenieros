...
namespace APU.Presentacion
{
    public class PaginaBase : System.Web.UI.Page
    {
        ...
        public void LlenarLista(ListBox combo, object ds, string dataValue, string dataField)
        {
            combo.DataValueField = dataValue;
            combo.DataTextField = dataField;
            combo.DataSource = ds;
        ...
        public static UsuarioInfo ObtenerUsuarioInfo()
        {
            ...
            if (oUsuarioInfo == null)
            {
                ...
                System.Web.HttpContext.Current.Response.Redirect("~/Login.aspx?returnURL=" + returnURL, true);
            }

            return oUsuarioInfo;
        }
        //protected static string ObtenerParametroGlobal(string nombreParametro)
        //{
        //    var ws = new WS_SMART.SmartClient();
        //    System.Web.Caching.Cache dataCache = HttpRuntime.Cache;
        //    if (dataCache[nombreParametro] == null)
        //    {
        //        //var valorParametro = Negocio.Helper.ObtenerValorParametro(nombreParametro);
        //        var valorParametro = ws.Helper_ObtenerValorParametro(nombreParametro);
        //        //var numeroHoras = Convert.ToInt16(Negocio.Helper.ObtenerValorParametro(Constantes.NRO_HORAS_CACHE));
        //        var numeroHoras = Convert.ToInt16(ws.Helper_ObtenerValorParametro(Constantes.NRO_HORAS_CACHE));
        //        dataCache.Insert(nombreParametro, valorParametro, null, DateTime.Now.AddHours(numeroHoras), TimeSpan.Zero);
        //    }
        //    return dataCache[nombreParametro].ToString();
        //}
    }
}