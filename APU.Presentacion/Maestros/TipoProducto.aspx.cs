...
{
	public partial class TipoProducto : PaginaBase
	{
		...
		private void CargarDatos()
		{
			...
			var tipoProductoLista = new Negocio.TipoProducto().ListarPaginado(0, numeroRegistros, indicePagina);
		...
		{
			return new Negocio.TipoProducto().Listar(usuarioId, 0, Constantes.PrimerNivelProducto).FirstOrDefault();
		}
		[WebMethod]
