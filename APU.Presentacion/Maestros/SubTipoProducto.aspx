<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubTipoProducto.aspx.cs" Inherits="APU.Presentacion.Maestros.SubTipoProducto" %>
...
<script type="text/javascript">
    ...
    function LimpiarUsuario() {
        ...
        document.getElementById('lblTituloUsuario').innerText = 'Sub Tipo Producto';
        txtNombre.value = '';
    ...
    function ObtenerUsuarioOk(u) {
        ...
        if (u != null) {
            ...
            ddlTipoProducto.value = u.TipoProductoPadreId;
    ...
    function ValidarUsuario() {
        ...
        if (txtNombre.value.trim() == '') {
            return MostrarValidacion(txtNombre, 'Ingrese Nombre Sub Producto.');
        }           
        
        if (ddlTipoProducto.value == '0') {
    ...
    <asp:Button id="btnDefault" OnClientClick="return false;" style="display: none;" runat="server" />
        ...
        <div id="contenedor">
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="text-align: center;" colspan="5">
                            <asp:Label CssClass="lblTitulo" Width="100%" runat="server">SUBTIPO DE PRODUCTO</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;">
                                ...
                                <table id="dummyHeader" style="width: 1200px;" class="tblSinBordes">
                                    <thead>
                                        <tr class="filaCabeceraGrid">
                                            ...
                                            <th style="width: 30%; cursor: pointer; text-decoration: underline;">Descripcion</th>                                          
                                            <th style="width: 20%; cursor: pointer; text-decoration: underline;">Tipo Producto</th>                                          
            ...
            <asp:Panel ID="pnlUsuario" runat="server" CssClass="pnlModal" style="display: none;">
                <table style="width: 100%;">
                    <tr id="lblTituloPopupSubTipoProducto" class="lblTituloPopup">
                        <td style="width: 20%;" class="lblTituloPopup">&nbsp;</td>
                        <td id="lblTituloUsuario" class="lblTituloPopup" style="width: 60%">Sub Tipo de Producto</td>
                                        ...
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList id="ddlTipoProducto" CssClass="ddlStandar" runat="server" Width="300px" />
                                                </td>
                                            </tr>                                           
                                            <tr>
